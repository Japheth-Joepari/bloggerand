                ...
                <div class="card-header d-flex ">
                    ...
                    <div class="col lg-8 ">
                      <div class="input-group ml-auto">
                        <form method="POST" action="{{ url('/search')}}" class="form-inline md-form form-sm mt-0">
                          @csrf
                          <input type="text" name="search" value="" class="form-control" placeholder="Search">
                        <span class="input-group-btn">   <button type="submit" name="button" class="btn btn-danger"><span><i class="fa fa-search"></i> </span> </button></span>
